...
(function() {
    ...
    angular.module('BlurAdmin.pages.Insights')
        .controller('InsightsChart5Ctrl', ["$scope", "baConfig", "$element", "layoutPaths", InsightsChart5Ctrl]);

    /** @ngInject */
    function InsightsChart5Ctrl($scope, baConfig, $element, layoutPaths) {
        console.log("i am here")
        $scope.viewByChart5 = "chart"
        var id = "InsightsChart5"
